...
export default class Quotebox extends Component {
    ...
    //when user click new quote button this function gives randome quotes from the array
    newquote=()=>{
        let randomequote=quotes[(Math.floor(Math.random() * quotes.length))]
        // console.log(randomequote)
        // console.log(quotes.length);
     //seting the new state 
        this.setState({
            quote:randomequote.quote,
            author:randomequote.author
        })
    ...
    render() {
        ...
        <div  id="quote-box">
            ...
            <h2 id="text" className='quote-text'> <FontAwesomeIcon icon={['fab', 'quote-left']} />{this.state.quote}
            </h2>
